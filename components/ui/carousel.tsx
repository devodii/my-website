...
export const useCarousel = () => React.useContext(parseElementContext(CarouselContext))

export const Root = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & CarouselProps>(
...
const Previous = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof ButtonPrimitive.Main>>(
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    const { orientation, scrollPrev, canScrollPrev } = useCarousel()

    return (
      <ButtonPrimitive.Main
        ref={ref}
        variant={variant}
        size={size}
        className={cn(
...
const Next = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof ButtonPrimitive.Main>>(
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
