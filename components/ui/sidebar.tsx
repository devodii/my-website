...
import * as SkeletonPrimitive from "@/components/ui/skeleton"
import { parseElementContext } from "@/lib/context"
...
export const useSidebar = () => parseElementContext(React.useContext(SidebarContext))
...
const SidebarTrigger = React.forwardRef<React.ElementRef<typeof ButtonPrimitive.Root>, React.ComponentProps<typeof ButtonPrimitive.Root>>(
...
>(({ className, ...props }, ref) => {
  return (
    <SeparatorPrimitive.Root ref={ref} data-sidebar="separator" className={cn("mx-2 w-auto bg-sidebar-border", className)} {...props} />
  )
})
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div ref={ref} data-sidebar="menu-skeleton" className={cn("rounded-md h-8 flex gap-2 px-2 items-center", className)} {...props}>
      {showIcon && <SkeletonPrimitive.Root className="size-4 rounded-md" data-sidebar="menu-skeleton-icon" />}
