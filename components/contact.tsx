        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card.Root className="border border-border">
            <Card.Header>
              ...
              <Card.Description>Feel free to reach out through any of these channels</Card.Description>
            </Card.Header>
          ...
          <Card.Root className="border border-border">
            <Card.Header>
              ...
              <Card.Description>I'll get back to you as soon as possible</Card.Description>
            </Card.Header>
            <Card.Content>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <div className="space-y-1">
                      <Input.Root {...field} placeholder="Your Name" />
                      <p
                        className={cn(
                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <div className="space-y-1">
                      <Input.Root {...field} type="email" placeholder="Your Email" />
                      <p
                        className={cn(
                          "text-red-500 text-sm transition-all duration-300 ease-in-out",
                          error ? "max-h-[100px] opacity-100" : "h-0 opacity-0",
                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <div className="space-y-1">
                      <Textarea.Root {...field} placeholder="Your Message" rows={4} />
                      <p
                        className={cn(
                          "text-red-500 text-sm transition-all duration-300 ease-in-out",
                          error ? "max-h-[100px] opacity-100" : "h-0 opacity-0",
                ...
                <Button.Root disabled={isLoading} type="submit" className="w-full">
                  Send Message
                </Button.Root>
              </form>
            </Card.Content>
